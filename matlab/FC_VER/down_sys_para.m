function [data] = down_sys_para(rts,rts_delay,rece,freq_lo,freq_center,waveband,varargin)
%%%%%%%%%%%%%%%%%%%%%%%%默认参数配置%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%END%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    syspara(9)  = freq_lo * 1e3;
    % 中心频率
    syspara(10) = freq_center * 1e3;
    % RCS校正值，精度0.1dB，范围-100~100，单位dB
    syspara(11) = uint_int(default_parameter.Results.rcs_corr)*10;
