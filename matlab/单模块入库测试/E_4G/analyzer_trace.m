...
% inst = load("data\trace_hui+lan_83630B.mat");
inst = load("data\trace_hui+lan.mat");
...
%%
amp_meas =data.amp_meas;
trace = data.amp_meas - amp_inst_sig_spec  - amp_inst_hunpin; % shangbianpin
% trace  = data.trace -  amp_inst_sig_spec - amp_inst_beipin; % xiabinpin
fre_set = data.fre_set;

% trace = data.trace - amp_inst_sig_spec;  % 自闭环
