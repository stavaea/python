...
fre_end              = 81000 ;
amp_set              = -10  ;
Lf_freq              = 11750;%%11920  11750
% temp = '5G231001001_Lf_freq_13533_down';
temp = '4G_11750_240410005_down';
%% Signal Source 83630B program
mult                 = 6;
GPIB_83630B          = 'GPIB1::20::INSTR' ;
% GPIB_83630B          = 'GPIB0::4::INSTR' ;

fre_set              = linspace(fre_start,80000,51) ;
% fre_set              = linspace(77000,fre_end,51) ;
% amp_set              = -30                ;
%% Spec Program
...
save(savefile,'fre_set',"amp_set","trace","spec_fre_set",'Lf_freq');
