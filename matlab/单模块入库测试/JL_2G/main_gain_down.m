...
spec_fre_set = linspace(240,2240,1001);
span    = 100;
rbw     = 10;
y_ref   = 20;
y_div   = 10;
...
temp = '2G模块';
clock1 = clock;
savefile = strcat('data\gain\',sprintf('%04d%02d%02d_%02d%02d%02.0f_gain_down_%s',clock1(1),clock1(2), ...
    clock1(3),clock1(4),clock1(5),clock1(6),temp))
save(savefile,'amp_meas','fre_meas',"fre_set","amp_set");
