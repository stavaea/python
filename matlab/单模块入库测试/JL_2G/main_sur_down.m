...
fre_end              = 81000 ;
amp_set              = -10  ;
temp = 'down_202311001-JL-MMWTR-2309_lf9845';
LF_freq              = 9845 ; %9470,9595,9845
%% Signal Source 83630B program
mult                 = 6;
GPIB_83630B          = 'GPIB0::0::INSTR' ;
% fre_set              = linspace(fre_start,78000,11) ;
% fre_set              = linspace(77000,79000,11) ;
fre_set              = linspace(79000,fre_end,11) ;
% amp_set             = -30                ;
...
pause(1)
fprintf(N9020A,'FREQ:STAR %f MHz',spec_fre_set(1));pause(1)
fprintf(N9020A,'FREQ:STOP %f MHz',spec_fre_set(end));pause(1)
