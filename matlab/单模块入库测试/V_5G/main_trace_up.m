...
% Lf_freq1 = 12050;Lf_freq2 = 13550;
% LF = linspace(Lf_freq1, Lf_freq2, 1001);
...
fre_set1              = fre_set - fre_set(1)+ 58000 - 300;
...
save(savefile,'fre_set',"amp_set","fre_meas","amp_meas","spec_fre_set");
