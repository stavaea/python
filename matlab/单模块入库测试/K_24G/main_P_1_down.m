...
fre_start            = 23000  ;
fre_end              = 25000  ;
amp_set              = -15:0.2:-5   ; %% 接收-35dBm 发射是-45dBm
Lf_freq              = 9213  ;
...
% point                = 2001;
spec_fre_set = fre_set - Lf_freq * 2 ;% * 2  + 0.002971
span    = 100 ;
rbw     = 10  ;
y_ref   = 10 ;
y_div   = 10  ;
...
savefile = strcat('data\P_1_down\',sprintf('%04d%02d%02d_%02d%02d%02.0f_trace_%s',clock1(1),clock1(2), ...
