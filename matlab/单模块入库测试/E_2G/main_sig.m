...
pause(1)
fprintf(N9020A,'FREQ:STAR %f MHz',fre_set(1));
fprintf(N9020A,'FREQ:STOP %f MHz',fre_set(end));
...
savefile = strcat('data\',sprintf('%04d%02d%02d_%02d%02d%02.0f_trace_%s',clock1(1),clock1(2), ...
