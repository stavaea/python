...
spec_fre_set = fre_set ;%- Lf_freq * 4;%fre_set;
span    = 100;
rbw     = 10;
y_ref   = -15;
y_div   = 10;
...
pause(1)
fprintf(N9020A,'FREQ:STAR %f MHz',fre_set(1)-20);pause(1)
fprintf(N9020A,'FREQ:STOP %f MHz',fre_set(end)+20);pause(1)
...
spurious_data(keysight83630B,N9020A,fre_set,point,att);
...
savefile = strcat('data\sur\',sprintf('%04d%02d%02d_%02d%02d%02.0f_spurious_%s',clock1(1),clock1(2), ...
    clock1(3),clock1(4),clock1(5),clock1(6),temp))
save(savefile,'fre_meas','amp_meas',"amp_meas1","spurious","trace","spec_fre_set","fre_set");
